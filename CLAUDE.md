...
| 번호 | 폴더 | 내용 | 상태 |
|------|------|------|------|
| 00 | exp00_vision_extraction | Vision LLM 상품정보 추출 | 프로토 완료, v2 재실험 예정 |
| 01 | exp01_vision_accuracy | 추출 정확도 (GT 대비) | 폴더·README만 |
| 02 | exp02_marketing_trigger | 마케팅 트리거 분류 | 폴더·README만 |
| 03 | exp03_style_similarity | style_similarity 검증 | 폴더·README만 |
| 04 | exp04_chatbot_ttoba | 또바 대화 품질 | 폴더·README만 |
| 05 | exp05_score_distribution | Impulse/Match Score 분포 & 구간 설계 | **다음 코딩 대상** |
...
| `scoring/impulse.py` | ✅ | `compute_impulse_score()` — 검증 완료 |
...
| `marketing_detector.py` | ⬜ | 키워드 기반 트리거 검출 |
