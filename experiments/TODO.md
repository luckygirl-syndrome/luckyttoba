...
> 1차 작업 완료 후 진행. 각 실험은 병렬 가능.

### 7-1. context_sentences 룰베이스 vs LLM 비교

🚫 **선행 조건:** 시험 4 기본 시나리오 완료

| # | 작업 | 상태 | 비고 |
|---|------|------|------|
| 7-1a | LLM context_sentences 생성 프롬프트 작성 | ⬜ | |
| 7-1b | 동일 시나리오 룰베이스 vs LLM 응답 비교 실행 | ⬜ | |
| 7-1c | 결과 정성 평가 | ⬜ 👤 | |

### 7-2. SBTI 설명 수준 비교

🚫 **선행 조건:** 시험 4 기본 시나리오 완료 + 긴장관계 평가용 유형 확정 (U-9)

| # | 작업 | 상태 | 비고 |
|---|------|------|------|
| 7-2a | 비교 조건별 system_prompt 변형 5종 생성 | ⬜ | 축 개요/상세, 유형 개요/상세, 축+긴장관계 |
| 7-2b | 동일 시나리오에 대해 5종 프롬프트로 응답 생성 | ⬜ | |
| 7-2c | 응답 품질 비교 (톤, SBTI 반영도, 방향 정확성) | ⬜ 👤 | |
...
| # | 작업 | 상태 | 비고 |
|---|------|------|------|
| 7-3a | 룰베이스 키워드 목록 + 가중치 설계 | ⬜ | |
| 7-3b | 100장에 대해 룰베이스 vs LLM 추출 비교 | ⬜ | |
| 7-3c | GT 대비 P/R/F1 비교 + 방식 결정 | ⬜ | |
